      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            console.log(_context.t0); //에러가 발생한경우 videos는 빈 배열로 실행 시킨다.(즉, 비디오가 없는 상태로 render)
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            console.log("search Error", _context2.t0);
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _req$body = req.body, title = _req$body.title, description = _req$body.description, location = req.file.location; // console.log("req.file:::::::", req.file);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 9:
            ...
            console.log(_context4.t0); //해당 id를 갖는 비디오가 없는 경우 home로 이동시킨다.
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 12:
            ...
            console.log("getEditVideo 에러", _context5.t0);
            res.redirect(_routes["default"].home);
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 7:
            ...
            console.log("postEditVideo 에러", _context6.t0);
            res.redirect(_routes["default"].home);
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 16:
            ...
            console.log("deleteError", _context7.t0);
...
function () {
  ...
  regeneratorRuntime.mark(function _callee10(req, res) {
    var _req$params, id, id2, video;

    return regeneratorRuntime.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            _req$params = req.params, id = _req$params.id, id2 = _req$params.id2;
            _context10.prev = 1;
            _context10.next = 4;
            return _Video["default"].findById(id);
          ...
          case 7:
            _context10.next = 9;
            return video.comments.pull(id2);
